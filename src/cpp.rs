...
pub mod root {
    ...
    pub mod app {
		...
		#[repr(transparent)]
        #[derive(Debug, Copy, Clone)]
        pub struct ItemKineticType (pub i32);
        #[repr(C)]
        #[derive(Debug, Copy, Clone)]
		...
		pub mod ai {
            ...
            use super::super::super::root;
			extern "C" {
                #[link_name = "\u{1}_ZN3app2ai14check_stat_airEP9lua_State"]
                pub fn check_stat_air(
					lua_state: u64
				)-> bool;
            }
			extern "C" {
                #[link_name = "\u{1}_ZN7lua2cpp20L2CFighterAIModeBase18change_mode_actionEN3lib8L2CValueE"]
                pub fn change_mode_action(
					ai_base: *mut crate::common::root::lua2cpp::L2CFighterAIModeBase,
					action: *const root::lib::L2CValue,
				);
            }
		}
		...
		pub mod lua_bind {
			...
			pub mod ControlModule {
				...
				extern "C" {
					...
					pub fn check_button_on_trigger(
						module_accessor: *mut root::app::BattleObjectModuleAccessor,
						arg2: libc::c_int,
					) -> bool;
				}
